...
import { FileText, Users, CheckCircle, X, AlertCircle, Download, Printer, Calendar, MapPin, Clock, FileDown } from 'lucide-react';
  ...
  const loadAttendanceData = async () => {
    try {
      const { data, error } = await supabase
        ...
        .select(`
          *,
          members:member_id (id, name, surname, email, phone)
        `)
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {meetings.filter(m => m.status === 'scheduled' || m.status === 'completed').map((meeting) => (
            ...
            >
              ...
              {meeting.topic && <p className="text-sm text-gray-600 truncate">{meeting.topic}</p>}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 capitalize">{selectedMeeting.status}</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-yellow-800">Absent with Reason</span>
                    </div>
