      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-2xl shadow-xl">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder={loginMethod === 'email' ? '••••••••' : 'Enter your PIN'}
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="font-medium text-blue-900 text-sm">Quick Login Credentials:</p>
            </div>
            <div className="space-y-3">
              {/* Developer Account */}
              <div className="bg-white rounded-lg p-3 border border-blue-100 shadow-sm">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-medium text-blue-800 text-sm">👑 Developer Account</span>
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full font-medium">Full Access</span>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <button
                    type="button"
                    onClick={() => handleDemoLogin('admin1@church.com', 'admin2025', 'email')}
                    className="text-left text-blue-700 hover:text-blue-900 transition-colors text-xs p-2 bg-blue-50 rounded hover:bg-blue-100 disabled:opacity-50"
                    disabled={loading}
                  >
                    <div className="font-semibold">Email:</div>
                    admin1@church.com<br />
                    admin2025
                  </button>
                  <button
                    type="button"
                    onClick={() => handleDemoLogin('developer', '2025', 'username')}
                    className="text-left text-blue-700 hover:text-blue-900 transition-colors text-xs p-2 bg-blue-50 rounded hover:bg-blue-100 disabled:opacity-50"
                    disabled={loading}
                  >
                    <div className="font-semibold">Username/PIN:</div>
                    developer<br />
                    2025
                  </button>
                </div>
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full text-left text-gray-700 hover:text-gray-900 transition-colors text-sm p-2 bg-white rounded-lg hover:bg-gray-50 disabled:opacity-50 border border-gray-200"
                  disabled={loading}
                >
                  <span className="font-medium">Regular Admin:</span><br />
                ...
                <button
                  ...
                  disabled={loading}
                >
                  <span className="font-medium">Member Account:</span><br />
        ...
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
          ...
          <ul className="text-xs text-gray-600 space-y-1">
            <li>• <strong>Developer Account:</strong> Full system access for development/testing</li>
